...
class Program {
    static void Main(string[] args) {
        ...
        Indica i1 = new Indica("Petrol", 5, "GJ-06-AB-1111", IVehicle.Renttype.Day, 15, 20, new DateOnly(2021, 12,16 ));
        Indica i2 = new Indica("Petrol", 5, "GJ-06-XY-9999", IVehicle.Renttype.Day, 5, 10, new DateOnly(2021, 12,16 ));

        MercedesBenz mb1 = new MercedesBenz("Petrol",7, "GJ-06-CD-2222", IVehicle.Renttype.KM, 15, 20, new DateOnly(2021, 07,18 ));

        Qualis q1 = new Qualis("Diesel", 7, "GJ-06-EF-3333", IVehicle.Renttype.KM, 10, 15, new DateOnly(2021, 11,21));
        Qualis q2 = new Qualis("Diesel", 4, "GJ-06-GH-4444", IVehicle.Renttype.KM, 10, 15, new DateOnly(2021, 02,28 ));

        MercedesBenz mb2 = new MercedesBenz("Petrol",7, "GJ-01-IJ-5555", IVehicle.Renttype.KM, 5, 10, new DateOnly(2021, 10,26 ));
